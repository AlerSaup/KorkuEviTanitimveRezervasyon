...
namespace _231103015_Ali_Yahya_Atasever.Controllers
{
    public class RezervasyonsController : Controller
    {
        ...
        public RezervasyonsController(KorkueviContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Ad,Soyad,Telefon,RezervasyonTarihi")] Rezervasyon rezervasyon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ad,Soyad,Telefon,RezervasyonTarihi")] Rezervasyon rezervasyon)
        {
